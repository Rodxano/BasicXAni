...
goto fail
:1.7.10
(echo ofRenderDistanceChunks:64) > optionsof.txt
...
SET msgboxBody=Please restart your Minecraft if it is running. Make sure that your Graphics are set to FANCY and render distance to 64 or 32 (you can turn it higher but this is a good number).
